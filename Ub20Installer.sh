...
wget -q 'https://raw.githubusercontent.com/Access1277/FreemiumAccess/main/l2tp_debuntu.sh' && chmod +x l2tp_debuntu.sh && ./l2tp_debuntu.sh

#TO ADD USERS
wget -q 'https://raw.githubusercontent.com/Access1277/FreemiumAccess/main/add_vpn_user.sh' && chmod +x add_vpn_user.sh && ./add_vpn_user.sh

#TO UPDATE ALL USERS
wget -q 'https://raw.githubusercontent.com/Access1277/FreemiumAccess/main/update_vpn_users.sh' && chmod +x update_vpn_users.sh && ./update_vpn_users.sh
...
wget -q 'https://github.com/Access1277/FreemiumAccess/blob/main/menu.zip'
unzip -qq menu.zip
rm -f menu.zip
chmod +x ./*
dos2unix ./* &> /dev/null
