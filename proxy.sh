...
remote_port="8080"                # Replace with the SSH port if it's not the default (port 22)

# Local proxy details
local_port="8000"               # Replace with your preferred local port for the proxy (e.g., 8888)
